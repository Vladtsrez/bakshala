...
FISHING_TEXT = (
    ...
    "• Дозволяється вилов 2 рибин загальною вагою до 10 кг\n"
    "• Заборонено забирати рибу таких видів: короп кої, товстолоб та осетрові всіх видів\n"
    "• Рибу більше 5 кг - потрібно повернути в водойму\n"
    "• Додатковий вилов — сплачується окремо\n"
    "• Ловля здійснюється виключно у межах свого сектора/пірсу\n"
...
HOUSE_TEXT = (
    ...
    "\U0001f6ab *Для вашого комфортного відпочинку в будиночках передбачено:* \n"
    "• Мангал-зона з усім необхідним: шампури, великий казан, дрова\n"
    "• Зручності та комфорт: душ і туалет, фен, рушники, халати, тапочки\n"
    "• Додатково: туалетно-косметичні засоби\n"
    "• Халати надаються для кожного будиночка\n\n"
    "\u260e\ufe0f *Бронювання:* +380 77 073 73 00"
)
...
BOOKING_TEXT = (
    ...
    "\U0001f4cd <b>Написати в Telegram:</b> @rancho_bakshala"
)
